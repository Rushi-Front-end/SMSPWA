...
import StaffBranchesDetails from './staffBranchesDetails';
                ...
                <div className="xl:col-span-12 col-span-12">
                    <div className="grid grid-cols-12 gap-x-6">
                        <div className="xxl:col-span-4 xl:col-span-12 col-span-12">
                            ...
                            <h4>Staff Details</h4>
                            <div className="staff-flex-container m-4">
                                            ...
                                            <div id="underline-1"  role="tabpanel" aria-labelledby="underline-item-1">
                                                <div className='flex-container'>
                                                    <div className="flex justify-end">
                                                        <button type="button" className="ti-btn ti-btn-outline-secondary !rounded-full ti-btn-wave pr-2">+ Edit Staff</button>
                                                        <button type="button" className="ti-btn ti-btn-outline-success !rounded-full ti-btn-wave">Referesh</button>
                                                    </div>
                                                </div>
                                                <div className='school-deatils-table'>
                                                    <h6 className='pb-4'>Personal  Details</h6>
                                                   <StaffCardDetails />
