...
import {postSchoolList } from '../../../redux/reducers/schoolReducer';
                    ...
                    <div className='student-create-btn'>
                        <div className='flex justify-end'>
                            ...
                            <Link to={`${import.meta.env.BASE_URL}pages/schools/allSchools`}>
                                ...
                                {/* <button onClick={removeUpdateValue} type="button" className="ti-btn ti-btn-info-full ml-15 !rounded-full ti-btn-wave">Cancel</button> */}
